...
class Geometry:
    ...
    def cart_forces(self, cart_forces):
        ...
        assert cart_forces.shape == self.cart_coords.shape, f"cart_forces.shape: {cart_forces.shape}, self.cart_coords.shape: {self.cart_coords.shape}"
    ...
    def hessian(self):
        ...
        hessian = hessian.reshape(self.cart_coords.size, self.cart_coords.size)
        if self.internal:
